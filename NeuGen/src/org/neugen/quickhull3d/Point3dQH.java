 ...
 */
public class Point3dQH extends Vector3d {

    /**
     * Creates a Point3dQH and initializes it to zero.
     */
    public Point3dQH() {
    }

    /**
     * Creates a Point3dQH by copying a vector
     *
     * @param v
     *                vector to be copied
     */
    public Point3dQH(Vector3d v) {
        set(v);
    }

    /**
     * Creates a Point3dQH with the supplied element values.
     *
     * @param x
     *                first element
     * @param y
     ...
     *                third element
     */
    public Point3dQH(double x, double y, double z) {
        set(x, y, z);
    }
}
