...
class Face {
    ...
    public void computeCentroid(Point3dQH centroid) {
        centroid.setZero();
        HalfEdge he = he0;
        do {
    ...
    public void computeNormal(Vector3d normal, double minArea) {
        ...
        if (area < minArea) {
            ...
            Point3dQH p2 = hedgeMax.head().pnt;
            Point3dQH p1 = hedgeMax.tail().pnt;
    ...
    public void computeNormal(Vector3d normal) {
        ...
        Point3dQH p0 = he0.head().pnt;
        Point3dQH p2 = he1.head().pnt;
     ...
     */
    public double distanceToPlane(Point3dQH p) {
    ...
    private Face connectHalfEdges(HalfEdge hedgePrev, HalfEdge hedge) {
        ...
        if (hedgePrev.oppositeFace() == hedge.oppositeFace()) { // then there is a redundant edge that we can get rid
            // off
            ...
            if (oppFace.numVertices() == 3) { // then we can get rid of the opposite face
                // altogether
    ...
    void checkConsistency() {
        ...
        do {
            ...
            if (hedgeOpp == null) {
                ...
                throw new InternalErrorException("face " + getVertexString() + ": " + "opposite half edge " + hedgeOpp.getVertexString() + " has opposite " + hedgeOpp.getOpposite().getVertexString());
            }
    ...
    private double areaSquared(HalfEdge hedge0, HalfEdge hedge1) {
        ...
        Point3dQH p0 = hedge0.tail().pnt;
        Point3dQH p1 = hedge0.head().pnt;
        Point3dQH p2 = hedge1.head().pnt;
