...
public final class NeuroMLSynapseBilateral implements NeuroMLSynapse {
	...
	public int getPost_cell_id() {
		return post_cell_id;
	}

	public void setPost_cell_id(int post_cell_id) {
		this.post_cell_id = post_cell_id;
	}

	public int getPost_segment_id() {
		return post_segment_id;
	}

	public void setPost_segment_id(int post_segment_id) {
		this.post_segment_id = post_segment_id;
	}

	public float getPost_fraction_along() {
		return post_fraction_along;
	}

	public void setPost_fraction_along(float post_fraction_along) {
		this.post_fraction_along = post_fraction_along;
	}
