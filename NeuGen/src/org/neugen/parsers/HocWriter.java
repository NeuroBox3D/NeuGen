...
public final class HocWriter {
    ...
    public final void writetohocSegment(Writer fw, int start_end, Segment segment) throws IOException {
        ...
        if (start_end == 0) {
            ...
            fw.write(sstart.x + ", " + sstart.y + ", " + sstart.z + ", ");
            fw.write(segment.getStartRadius() * 2 + ")\n");
        }
        if (start_end == 1) {
            Point3f send = segment.getEnd();
            fw.write(send.x + ", " + send.y + ", " + send.z + ", ");
    ...
    /**
     * Function to write a hoc file for the data of net.
     ...
     * Function to write a hoc file for the data of net.
     * NEURON will write a file with the voltage data of the somata
     * and a second file with the data of NetCon events.
     *
    ...
    /** 
     * Function to write a hoc file for the data of net. NEURON will write a file with the data of NetCon events.
     * @param fname the name of the file.
     * @param events_postfix the postfix of the name of the file for the NetCon events data.
     */
