...
/**
 * class for visualizing denritic densities
 * 
 * @author Simone Eberhard
 */
@SuppressWarnings("serial")
public final class NeuGenDensityVisualization {

    /** use to log messages */
    private static Logger logger = Logger.getLogger(NeuGenDensityVisualization.class.getName());
    ...
    public static NeuGenDensityVisualization getInstance() {
        return INSTANCE;
    }

    public static void setInstance(NeuGenDensityVisualization INSTANCE) {
        NeuGenDensityVisualization.INSTANCE = INSTANCE;
    }
     ...
     */
    public NeuGenDensityVisualization(VolumeOfVoxels vov, BranchGroup bg) {
        this.scene = bg;
        ngView = NeuGenView.getInstance();
        task = DensityVisualizationTask.getInstance();
        ...
        DensityVisualizationTask.Density dens = ngView.getDensity();
    ...
    public void destroy() {
        ...
        C3DScrollPane.setBorder(javax.swing.BorderFactory.createTitledBorder("Density Visualization"));
